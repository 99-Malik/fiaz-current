...
export default function SamsungHeader() {
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-xl bg-white/95 border-b border-gray-100 shadow-sm">
      {/* Top Contact Bar */}
      <div className="hidden lg:block bg-gradient-to-r from-samsungPrimary via-gray-800 to-samsungPrimary text-white">
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <Link href="/companies/samsung" className="flex items-center">
              <Image
                quality={100}
                src="/samsung.svg"
                width={120}
          ...
          <div className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            <Navlink company="Samsung" href="/companies/samsung#about" title="About" />
            <Navlink company="Samsung" href="/companies/samsung#services" title="Services" />
            <Navlink company="Samsung" href="/companies/samsung#contact" title="Contact" />
          </div>
